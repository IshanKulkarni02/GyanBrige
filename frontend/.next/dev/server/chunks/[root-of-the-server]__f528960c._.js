...
async function GET(request) {
    try {
        ...
        let courseList = teacherId ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["courses"].getByTeacher(teacherId) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["courses"].getAll();
        // Enrich with lecture count and teacher info
        const enrichedCourses = courseList.map((course)=>{
            const courseLectures = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lectures"].getByCourse(course.id);
            ...
            const enrolled = userId ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enrollments"].get(userId, course.id) : null;
            return {
                ...course,
...
async function POST(request) {
    try {
        ...
        const newCourse = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["courses"].create({
            name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f528960c._.js.map
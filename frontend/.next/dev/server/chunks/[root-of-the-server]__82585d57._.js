...
async function POST(request) {
    try {
        ...
        if (inviteToken) {
            const invite = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invites"].isValid(inviteToken);
            if (!invite) {
        ...
        const existing = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["users"].getByEmail(email);
        if (existing) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Create user
        const newUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["users"].create({
            name,
            email,
            password,
            role: resolvedRole
        ...
        if (inviteToken) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["invites"].consume(inviteToken);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82585d57._.js.map
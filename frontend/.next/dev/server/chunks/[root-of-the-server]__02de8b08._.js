...
async function GET() {
    try {
        const allUsers = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["users"].getAll().map((u)=>({
                id: u.id,
                name: u.name,
                email: u.email,
                role: u.role,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02de8b08._.js.map
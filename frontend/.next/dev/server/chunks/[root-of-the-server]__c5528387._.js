...
"[project]/src/lib/oui.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/attendance/network-scan/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$oui$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/oui.ts [app-route] (ecmascript)");
;
;
;
;
...
function parseArpFull(output) {
    ...
    for (const line of lines){
        ...
        const vendor = randomized ? 'Randomized MAC' : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$oui$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lookupVendor"])(mac);
        devices.push({
            mac,
            ip,
            hostname,
...
function populateArpCache() {
    try {
        if ("TURBOPACK compile-time truthy", 1) {
            const ifaceResult = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawnSync"])('netstat', [
                '-rn'
            ], {
                timeout: 30000
            });
            ...
            const ipResult = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawnSync"])('ipconfig', [
                'getifaddr',
                iface
            ], {
                timeout: 30000
            ...
            if (parts.length === 4) {
                (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawnSync"])('ping', [
                    '-c',
                    '2',
                    '-t',
                    '1',
...
async function GET() {
    try {
        ...
        let arpOutput = '';
        try {
            const result = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawnSync"])('/usr/sbin/arp', [
                '-a'
            ], {
                timeout: 30000
            });
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'arp command unavailable on this server',
                devices: [],
                matchedStudents: [],
                unmatchedStudents: []
            }, {
        ...
        const allUsers = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["users"].getAll();
        const studentMacMap = new Map(allUsers.filter((u)=>u.role === 'student' && u.macAddress).map((u)=>[
                normalizeMac(u.macAddress),
                {
                    id: u.id,
                    name: u.name
                }
        ...
        const matchedStudents = allUsers.filter((u)=>u.role === 'student' && u.macAddress && onlineMacs.includes(normalizeMac(u.macAddress))).map((u)=>({
                id: u.id,
                name: u.name,
                email: u.email
            }));
        const unmatchedStudents = allUsers.filter((u)=>u.role === 'student' && !u.macAddress).map((u)=>({
                id: u.id,
                name: u.name,
                email: u.email
            }));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c5528387._.js.map
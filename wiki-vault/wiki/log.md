...
Wiki vault initialized for GyanBrige project. hot.md, index.md, overview.md seeded with project context. Claude Code hooks configured at `d:/projects/GyanBrige/GyanBrige/.claude/settings.json`.
